...
bot.polling(none_stop=True)
  ...
  # elif message.text == 'Контакты':
        #     markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        #     item1 = types.KeyboardButton('Насяльника')
        #     item2 = types.KeyboardButton('Равшан')
        #     item3 = types.KeyboardButton('Джамшут')
        #     back = types.KeyboardButton('Назад')
...
# def website(message):
#     markup = types.InlineKeyboardMarkup()
#     markup.add(types.InlineKeyboardButton('Website', url='https://127.0.0.1:8000/admin/'))
#     bot.send_message(message.chat.id, 'Для просмотра авиабилетов перейдите на сайт:', reply_markup=markup)
